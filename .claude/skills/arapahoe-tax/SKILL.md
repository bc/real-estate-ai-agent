...
```bash
python property_tax_estimator.py --county arapahoe --value <MARKET_VALUE>
```
...
```bash
python property_tax_estimator.py --county arapahoe --value <VALUE> --school-mills <SCHOOL> --local-mills <LOCAL>
```
